namespace StoreOfBuild.Domain.Products
{
    public class Product
    {
        ...
        {
            ValidadeValues(name, category, price, stockQuantity);
            SetProperty(name, category, price, stockQuantity);
        }

        private void SetProperty(string name, Category category, decimal price, int stockQuantity)
        {
            Name = name;
            Category = category;
            Price = price;
        ...
        private static void ValidadeValues(string name, Category category, decimal price, int stockQuantity)
        {
